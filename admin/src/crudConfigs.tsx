...
export const crudConfigs: CrudConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "dexterity", label: "Destreza", type: "number", defaultValue: 0, visibleIf: { field: "type", values: ["armor"] }, hint: "Armor: defesa e agilidade" },
      { name: "wisdom", label: "Sabedoria", type: "number", defaultValue: 0, visibleIf: { field: "type", values: ["helm", "cape", "necklace"] }, hint: "Helm/Cape/Necklace: utilidade" },
      { name: "luck", label: "Sorte", type: "number", defaultValue: 0, visibleIf: { field: "type", values: ["cape", "ring", "necklace"] }, hint: "Cape/Ring/Necklace: crit e drops" },
  ...
  },
  {
    ...
    fields: [
      { name: "name", label: "Name", type: "text", required: true },
      {
        ...
        label: "Type",
        type: "select",
        options: ["shop", "quest", "blacksmith", "trainer", "lore", "guard", "other"],
        defaultValue: "shop",
      },
      { name: "description", label: "Description", type: "textarea", required: true },
  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        options: ["diamond", "money", "gold"],
        hint: "money = moeda real (R$ em centavos). Os pagamentos reais continuam mock até integrar o PayPal.",
      },
