...
export const crudConfigs: CrudConfig[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "attackSpeedMs", label: "Velocidade da arma (ms)", type: "number", defaultValue: 0, visibleIf: { field: "type", values: ["weapon"] }, hint: "0 = padrão 2000ms (2s entre ataques). Única fonte de velocidade de ataque — a classe não define mais." },
      ...
      { name: "strength", label: "Força", type: "number", defaultValue: 0, visibleIf: { field: "type", values: ["weapon"] }, hint: "Armas físicas concedem Strength" },
      { name: "intellect", label: "Intelecto", type: "number", defaultValue: 0, visibleIf: { field: "type", values: ["weapon"] }, hint: "Armas mágicas concedem Intellect" },
      { name: "endurance", label: "Resistência", type: "number", defaultValue: 0, visibleIf: { field: "type", values: ["armor", "helm"] }, hint: "Helm/Armor: Endurance" },
      { name: "dexterity", label: "Destreza", type: "number", defaultValue: 0, visibleIf: { field: "type", values: ["armor", "helm"] }, hint: "Helm/Armor: Dexterity" },
      { name: "wisdom", label: "Sabedoria", type: "number", defaultValue: 0, visibleIf: { field: "type", values: ["cape", "ring", "necklace"] }, hint: "Capa/Colar/Anel: Wisdom" },
      { name: "luck", label: "Sorte", type: "number", defaultValue: 0, visibleIf: { field: "type", values: ["cape", "ring", "necklace"] }, hint: "Capa/Colar/Anel: Luck" },
  ...
  },
  {
    ...
    columns: [
      ...
      { key: "tier", label: "Nível", render: (v) => <span className="px-2 py-0.5 rounded-full text-xs bg-purple-500/20 text-purple-300">{"I".repeat(Math.max(1, Number(v) || 1))}</span> },
      { key: "minRank", label: "Min Rank" },
      { key: "price", label: "Preço (ouro)" },
    ],
    fields: [
      { name: "name", label: "Name", type: "text", required: true },
      { name: "slug", label: "Slug", type: "text", required: true, hint: "Unique, lowercase" },
      ...
      { name: "minRank", label: "Min Rank", type: "number", defaultValue: 1 },
      { name: "price", label: "Price (ouro)", type: "number", defaultValue: 0 },
      { name: "compatibleSlots", label: "Slots compatíveis (JSON array)", type: "json", jsonSchema: { mode: "object-array", addLabel: "Adicionar slot", fields: [
          { name: "slot", label: "Slot", type: "select", options: ["weapon", "class", "helm", "armor", "cape"] },
        ] }, hint: "Apenas equipamentos de combate: Arma, Elmo, Armadura e Capa" },
