  ...
  },
  {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: "Como cada Core Stat influencia os Combat Stats. Ex.: strength → attackPower ×1.50 | endurance → hp ×15 | wisdom → mana ×10 | dexterity → attackSpeedPercent +0.20 por ponto | luck → critChance +0.10 por ponto",
      },
