...
export const crudConfigs: CrudConfig[] = [
  {
    ...
    fields: [
      ...
      { name: "slug", label: "Slug", type: "text", placeholder: "e.g. shadowstalker", hint: "Lowercase, no spaces" },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "stats", label: "Stats (JSON)", type: "json", hint: '{"attack": 10, "defense": 5}' },
      { name: "requirements", label: "Requirements (JSON)", type: "json", hint: '{"level": 10}' },
      { name: "effects", label: "Effects (JSON)", type: "json", hint: '{"heal": 50}' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "objectives", label: "Objectives (JSON)", type: "json", hint: '[{"type":"kill","target":"slime","amount":5}]' },
      { name: "itemRewards", label: "Item Rewards (JSON)", type: "json", hint: '[{"itemId":"...","quantity":1}]' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: "statModifiers", label: "Stat Modifiers (JSON)", type: "json", hint: '{"attack": 10, "defense": -5}' },
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: "traits",
        label: "Stat Modifiers (JSON)",
        type: "json",
        hint: '{"baseHp": 20, "baseAttack": 5, "baseSpeed": 2, "manaRecovery": 1}',
      },
      { name: "isActive", label: "Active", type: "boolean", defaultValue: true },
    ],
  },
  {
    ...
    fields: [
      ...
      { name: "description", label: "Description", type: "textarea", required: true },
      {
        ...
        type: "json",
        hint: '{"xpBonus": 10, "goldBonus": 5, "critBonus": 2, "cooldownReduction": 5}',
      },
      { name: "isActive", label: "Active", type: "boolean", defaultValue: true },
    ],
  },
