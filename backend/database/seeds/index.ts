...
async function main() {
  ...
  const classes = [
    {
      ...
      manaRecovery: 3.0,
      attackScaling: 0.6, magicScaling: 0.3,
      critScaling: 0.08, critDamageBase: 200.0,
      dodgeScaling: 0.04, cooldownScaling: 0.03,
      manaEfficiency: 0.9,
      requiredLevel: 1,
    },
    {
      ...
      manaRecovery: 2.0,
      attackScaling: 0.4, magicScaling: 0.2,
      critScaling: 0.02, critDamageBase: 130.0,
      dodgeScaling: 0.01, cooldownScaling: 0.02,
      manaEfficiency: 1.2,
      requiredLevel: 1,
    },
    {
      ...
      manaRecovery: 8.0,
      attackScaling: 0.2, magicScaling: 0.8,
      critScaling: 0.06, critDamageBase: 160.0,
      dodgeScaling: 0.02, cooldownScaling: 0.04,
      manaEfficiency: 0.7,
      requiredLevel: 1,
    },
    {
      ...
      manaRecovery: 1.5,
      attackScaling: 0.9, magicScaling: 0.1,
      critScaling: 0.07, critDamageBase: 170.0,
      dodgeScaling: 0.02, cooldownScaling: 0.02,
      manaEfficiency: 1.1,
      requiredLevel: 1,
    },
    {
      ...
      manaRecovery: 7.0,
      attackScaling: 0.2, magicScaling: 0.6,
      critScaling: 0.04, critDamageBase: 140.0,
      dodgeScaling: 0.02, cooldownScaling: 0.05,
      manaEfficiency: 0.8,
      requiredLevel: 1,
    },
  ];
    ...
    const skills = [
      {
        ...
        type: "active", subType: "melee",
        cooldown: 4000, manaCost: 10, castTime: 200,
        range: 3, targetType: "enemy",
        rankRequired: 1, sortOrder: 1,
        baseDamage: 25, damageType: "physical", damageStat: "attackPower",
        damageScaling: JSON.stringify({ attack: 0.7 }),
        buffsApplied: JSON.stringify([]), debuffsApplied: JSON.stringify([]),
        stacksApplied: JSON.stringify({ stackId: "bleeding", amount: 1 }),
        hitsMultiple: false, maxTargets: 1,
        animationName: "shadow_strike", soundEffect: "slash",
      },
      {
        classId: shadowStalker.id,
        name: "Shadow Dance",
        ...
        type: "active", subType: "melee",
        cooldown: 8000, manaCost: 20, castTime: 500,
        range: 4, targetType: "enemy",
        rankRequired: 3, sortOrder: 2,
        baseDamage: 40, damageType: "physical", damageStat: "attackPower",
        damageScaling: JSON.stringify({ attack: 1.0 }),
        hitsMultiple: true, maxTargets: 3,
        animationName: "shadow_dance", soundEffect: "whoosh",
      },
      {
        classId: shadowStalker.id,
        ...
        type: "active", subType: "melee",
        cooldown: 12000, manaCost: 30, castTime: 300,
        range: 3, targetType: "enemy",
        rankRequired: 5, sortOrder: 3,
        baseDamage: 60, damageType: "dark", damageStat: "attackPower",
        damageScaling: JSON.stringify({ attack: 0.8, magic: 0.4 }),
        stacksRequired: JSON.stringify({ stackId: "bleeding", amount: 3, consume: true }),
        hitsMultiple: false, maxTargets: 1,
        animationName: "dark_energy_blade", soundEffect: "dark_slash",
      },
      {
        classId: shadowStalker.id,
        name: "Shadow Cloak",
        description: "Envelop yourself in shadows, gaining invisibility and increased critical chance.",
        type: "active", subType: "buff",
        cooldown: 20000, manaCost: 25, castTime: 0,
        range: 0, targetType: "self",
        rankRequired: 7, sortOrder: 4,
        baseDamage: 0, damageType: "physical",
        buffsApplied: JSON.stringify([{ buffId: "shadow_cloak", duration: 5000, stacks: 1 }]),
        hitsMultiple: false, maxTargets: 0,
        animationName: "shadow_cloak", soundEffect: "cloak",
      },
      {
        classId: shadowStalker.id,
        name: "Shadow Realm Execution",
        description: "Drag your target into the shadow realm, dealing massive damage based on missing HP.",
        type: "ultimate", subType: "melee",
        cooldown: 90000, manaCost: 50, castTime: 1000,
        range: 4, targetType: "enemy",
        rankRequired: 10, sortOrder: 10,
        baseDamage: 200, damageType: "true", damageStat: "attackPower",
        damageScaling: JSON.stringify({ attack: 2.5 }),
        hitsMultiple: false, maxTargets: 1,
        animationName: "shadow_realm", soundEffect: "shadow_realm",
      },
      {
        classId: shadowStalker.id,
        name: "Assassin's Instinct",
        description: "Passively increases critical damage and attack speed.",
        type: "passive", subType: null,
        cooldown: 0, manaCost: 0, castTime: 0,
        range: 0, targetType: "self",
        rankRequired: 2, sortOrder: 0,
        baseDamage: 0, damageType: "physical",
        hitsMultiple: false, maxTargets: 0,
      },
      {
  ...
  if (crystalGuardian) {
    const skills = [
      { name: "Crystal Shield Bash", description: "Bash the enemy with your crystal shield, dealing damage and stunning.", type: "active", subType: "melee", cooldown: 6000, manaCost: 15, castTime: 200, range: 3, targetType: "enemy", rankRequired: 1, sortOrder: 1, baseDamage: 20, damageType: "physical", damageStat: "attackPower", damageScaling: JSON.stringify({ defense: 0.6 }), debuffsApplied: JSON.stringify([{ buffId: "stun", duration: 1500, stacks: 1 }]), hitsMultiple: false, maxTargets: 1, animationName: "shield_bash", soundEffect: "bash" },
      { name: "Fortress Stance", description: "Enter a defensive stance, increasing defense and healing over time.", type: "active", subType: "buff", cooldown: 15000, manaCost: 20, castTime: 0, range: 0, targetType: "self", rankRequired: 3, sortOrder: 2, baseDamage: 0, damageType: "physical", buffsApplied: JSON.stringify([{ buffId: "fortress", duration: 8000, stacks: 1 }]), hitsMultiple: false, maxTargets: 0, animationName: "fortress", soundEffect: "fortress" },
      { name: "Crystal Eruption", description: "Crystals erupt from the ground, damaging and slowing enemies.", type: "active", subType: "aoe", cooldown: 10000, manaCost: 25, castTime: 500, range: 6, targetType: "area", rankRequired: 5, sortOrder: 3, baseDamage: 45, damageType: "magic", damageStat: "spellPower", damageScaling: JSON.stringify({ magicDefense: 0.7 }), hitsMultiple: true, maxTargets: 5, animationName: "crystal_eruption", soundEffect: "eruption" },
      { name: "Guardian's Sacrifice", description: "Take reduced damage and redirect ally damage to yourself.", type: "active", subType: "buff", cooldown: 30000, manaCost: 30, castTime: 0, range: 0, targetType: "self", rankRequired: 7, sortOrder: 4, baseDamage: 0, damageType: "physical", buffsApplied: JSON.stringify([{ buffId: "sacrifice", duration: 6000, stacks: 1 }]), hitsMultiple: false, maxTargets: 0, animationName: "sacrifice", soundEffect: "sacrifice" },
      { name: "Diamond Shell", description: "Ultimate: Encased in pure diamond, becoming immune to all damage and reflecting attacks.", type: "ultimate", subType: "buff", cooldown: 90000, manaCost: 60, castTime: 0, range: 0, targetType: "self", rankRequired: 10, sortOrder: 10, baseDamage: 0, damageType: "true", buffsApplied: JSON.stringify([{ buffId: "diamond_shell", duration: 4000, stacks: 1 }]), hitsMultiple: false, maxTargets: 0, animationName: "diamond_shell", soundEffect: "diamond" },
      { name: "Crystal Body", description: "Passively increases max HP and defense.", type: "passive", subType: null, cooldown: 0, manaCost: 0, castTime: 0, range: 0, targetType: "self", rankRequired: 2, sortOrder: 0, baseDamage: 0, damageType: "physical", hitsMultiple: false, maxTargets: 0 },
      { name: "Thorns Aura", description: "Passively reflects damage back to attackers.", type: "passive", subType: null, cooldown: 0, manaCost: 0, castTime: 0, range: 0, targetType: "self", rankRequired: 4, sortOrder: 0, baseDamage: 0, damageType: "physical", hitsMultiple: false, maxTargets: 0 },
    ];
    for (const skill of skills) {
      await prisma.skill.upsert({
        where: { id: skill.name.toLowerCase().replace(/\s+/g, "-") },
