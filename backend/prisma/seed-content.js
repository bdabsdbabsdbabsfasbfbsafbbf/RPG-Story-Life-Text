...
const classSkills = [
  {
    class: "cavaleiro",
    skills: [
      { name: "Golpe de Escudo", description: "Golpeia o inimigo com o escudo, causando dano físico.", type: "active", subType: "melee", cooldown: 3000, manaCost: 8, range: 5, targetType: "enemy", baseDamage: 12, damageType: "physical", damageScaling: '{"attack": 0.8}', buffsApplied: null, sortOrder: 1 },
      { name: "Postura Defensiva", description: "Ergue uma barreira arcana que aumenta sua defesa.", type: "active", subType: "buff", cooldown: 10000, manaCost: 10, range: 0, targetType: "self", baseDamage: 0, damageType: "physical", buffsApplied: ["Armadura Arcana"], sortOrder: 2 },
      { name: "Bastião", description: "Passiva: seu corpo endurece, aumentando a vida máxima e a defesa.", type: "passive", subType: "passive", cooldown: 0, manaCost: 0, range: 0, targetType: "self", baseDamage: 0, damageType: "physical", sortOrder: 3 },
      { name: "Juízo Final", description: "Um golpe devastador que abala a terra.", type: "ultimate", subType: "melee", cooldown: 30000, manaCost: 25, range: 5, targetType: "enemy", baseDamage: 40, damageType: "physical", damageScaling: '{"attack": 1.5}', sortOrder: 4 },
    ],
    passives: [
  ...
  },
  {
    class: "mago",
    skills: [
      { name: "Bola de Fogo", description: "Lança uma esfera de fogo que causa dano mágico.", type: "active", subType: "spell", cooldown: 4000, manaCost: 15, range: 8, targetType: "enemy", baseDamage: 18, damageType: "magic", damageScaling: '{"magic": 1.2}', sortOrder: 1 },
      { name: "Foco Arcano", description: "Concentra energia arcana, aumentando a recuperação de mana.", type: "active", subType: "buff", cooldown: 12000, manaCost: 10, range: 0, targetType: "self", baseDamage: 0, damageType: "magic", buffsApplied: ["Foco Arcano"], sortOrder: 2 },
      { name: "Chama Interior", description: "Passiva: sua afinidade com fogo aumenta o poder mágico.", type: "passive", subType: "passive", cooldown: 0, manaCost: 0, range: 0, targetType: "self", baseDamage: 0, damageType: "magic", sortOrder: 3 },
      { name: "Meteoro", description: "Invoca um meteoro que esmaga os inimigos.", type: "ultimate", subType: "aoe", cooldown: 30000, manaCost: 30, range: 10, targetType: "area", baseDamage: 50, damageType: "magic", damageScaling: '{"magic": 1.8}', sortOrder: 4 },
    ],
    passives: [
  ...
  },
  {
    class: "assassino",
    skills: [
      { name: "Golpe Sombrio", description: "Um ataque rápido vindo das sombras.", type: "active", subType: "melee", cooldown: 3500, manaCost: 10, range: 5, targetType: "enemy", baseDamage: 14, damageType: "physical", damageScaling: '{"attack": 1.1}', buffsApplied: ["Sangramento"], sortOrder: 1 },
      { name: "Passo Sombrio", description: "Desliza entre as sombras, aumentando sua esquiva.", type: "active", subType: "buff", cooldown: 12000, manaCost: 8, range: 0, targetType: "self", baseDamage: 0, damageType: "physical", buffsApplied: ["Passo das Sombras"], sortOrder: 2 },
      { name: "Sangue Frio", description: "Passiva: sua precisão aumenta os acertos críticos.", type: "passive", subType: "passive", cooldown: 0, manaCost: 0, range: 0, targetType: "self", baseDamage: 0, damageType: "physical", sortOrder: 3 },
      { name: "Execução", description: "Um golpe mortal que termina inimigos feridos.", type: "ultimate", subType: "melee", cooldown: 25000, manaCost: 20, range: 5, targetType: "enemy", baseDamage: 45, damageType: "physical", damageScaling: '{"attack": 1.6}', sortOrder: 4 },
    ],
    passives: [
  ...
  },
  {
    class: "suporte",
    skills: [
      { name: "Toque Curativo", description: "Cura o aliado alvo com luz divina.", type: "active", subType: "heal", cooldown: 4000, manaCost: 12, range: 8, targetType: "ally", baseDamage: 0, healingBase: 25, damageType: "magic", damageScaling: '{"magic": 0.9}', sortOrder: 1 },
      { name: "Palavra de Poder", description: "Encanta um aliado, aumentando seu ataque.", type: "active", subType: "buff", cooldown: 10000, manaCost: 10, range: 8, targetType: "ally", baseDamage: 0, damageType: "magic", buffsApplied: ["Fúria do Guerreiro"], sortOrder: 2 },
      { name: "Piedade", description: "Passiva: suas curas são mais poderosas.", type: "passive", subType: "passive", cooldown: 0, manaCost: 0, range: 0, targetType: "self", baseDamage: 0, damageType: "magic", sortOrder: 3 },
      { name: "Milagre", description: "Uma cura massiva que restaura grande parte da vida.", type: "ultimate", subType: "heal", cooldown: 30000, manaCost: 30, range: 10, targetType: "area", baseDamage: 0, healingBase: 80, damageType: "magic", damageScaling: '{"magic": 1.5}', sortOrder: 4 },
    ],
    passives: [
